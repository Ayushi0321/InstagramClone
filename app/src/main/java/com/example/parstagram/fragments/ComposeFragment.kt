    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            ...
            if (photoFile != null) {
                ...
                Toast.makeText(requireContext(), "Great! Post is saved", Toast.LENGTH_SHORT).show()
            } else {
                Log.e(MainActivity.TAG, "Error creating post")
                Toast.makeText(
                    requireContext(),
                    "Picture empty, Take Picture!!",
                    Toast.LENGTH_SHORT
                ).show()
            }
    ...
    fun submitPost(description: String, user: ParseUser, file: File) {
        ...
        post.saveInBackground { exception ->
            if (exception != null) {
                ...
                Toast.makeText(requireContext(), "Error while saving the post", Toast.LENGTH_SHORT).show()
            } else {
