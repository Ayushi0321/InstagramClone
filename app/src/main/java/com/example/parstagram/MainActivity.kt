    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btnSubmit).setOnClickListener{
            ...
            if (photoFile != null) {
                ...
                Toast.makeText(this, "Great! Post is saved", Toast.LENGTH_SHORT).show()
            } else {
                Log.e(TAG, "Error creating post")
                Toast.makeText(this, "Picture empty, Take Picture!!", Toast.LENGTH_SHORT).show()
            }
    ...
    fun submitPost(description: String, user: ParseUser, file: File) {
        ...
        post.saveInBackground { exception ->
            if (exception != null) {
                ...
                Toast.makeText(this, "Error while saving the post", Toast.LENGTH_SHORT).show()
            } else {
